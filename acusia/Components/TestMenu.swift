...
struct AuxiliaryPreviewBasicUsage01ControllerRepresentable: UIViewControllerRepresentable {
    
    func makeUIViewController(context: Context) -> AuxiliaryPreviewBasicUsage01Controller {
        return AuxiliaryPreviewBasicUsage01Controller()
    }
    
    func updateUIViewController(_ uiViewController: AuxiliaryPreviewBasicUsage01Controller, context: Context) {
        // No update needed for static preview
    }
}

struct AuxiliaryPreviewBasicUsage01Controller_Preview: PreviewProvider {
    static var previews: some View {
        AuxiliaryPreviewBasicUsage01ControllerRepresentable()
