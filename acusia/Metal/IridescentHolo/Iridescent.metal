...
vertex VertexOut vertex_main(VertexIn in [[stage_in]],
    ...
    out.worldNormal = normalize((uniforms.modelMatrix * float4(in.position, 0.0)).xyz);
...
fragment float4 fragment_main(VertexOut in [[stage_in]],
    ...
    float3 fullNormal = normalize(normal + normalMap * 0.1); // Adjust the 0.1 to control the bump strength
